...
st.write("Carte avec les points de trafic cycliste à 7h.")
st.write("Sur la carte ci-dessus, la taille des cercles nous donnent l'information de l'affluence sur chacun des sites. Nous avons d'ailleurs choisi de mettre les sites de comptages avec le plus d'affluence en vert et à l'inverse, ceux avec le moins d'affluence en rouge, pour les mettre en relief. Nous remarquons directement que les cinq sites de comptage enregistrant le plus de passages se trouvent plutôt au centre de Paris et côté rive droite où se trouvent de nombreux quartiers animés, alors que les cinq sites enregistrant le moins de passages se trouvent en périphérie, au niveau des portes de la ville, où on trouve davantage de quartiers calmes et résidentiels.")
...
st.write("En comparant avec la première carte, nous remarquons directement qu'en moyenne, les cercles sont bien plus grands (nous avons évidemment appliqué la même échelle qu'avant). Les zones de fortes affluence restent assez centrées. En revanche, nous observons cette fois que, même en périphérie, nos anciens faibles sites de comptage ont désormais une affluence au moins moyenne. Nous pouvons faire la supposition que cela est dû aux parisiens excentrés venant sur leur lieu de travail.")
